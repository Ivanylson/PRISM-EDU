...
for co_grupo in grupos_disponiveis:
    ...
    for ies in ies_disponiveis:
        ...
        # Fallback: Se nenhum K foi válido pelas regras estritas, força o K=2
        if silhueta_6 == -1: 
            melhor_k_6 = 2
            silhueta_livre = silhueta_10 = silhueta_6 = 0
        ...
        for rank, dados_grupo in enumerate(perfis_temp):
            ...
            linha = {
                ...
                'QUESTOES_MAIS_IMPACTANTES': ", ".join(questoes_impactantes) # <- Mantém todas para o Dashboard
            }
